...
public class ListarDepartamentoFrame extends JFrame {
	...
	private InputListenerListarDepartamentoFrame listenerDepartamento;
	private JPanel listPanel;
	private JScrollPane scrollPane;
	private JLabel lblListarDepartamento;

	public ListarDepartamentoFrame() {
		setTitle("Listar Departamento");
		initialize();
		listenerDepartamento = new InputListenerListarDepartamentoFrame(this, BancoDeDados.getInstance());
	...
	public JList<String> getList() {
		if (list == null) {
			list = new JList<String>(DepartamentoDAO.getInstance().getAllDepartamento());
	...
	public void refreshList(){
		list.setModel(DepartamentoDAO.getInstance().getAllDepartamento());
	}
	...
	private void inicializarListeners(){
		getBtnEditar().addActionListener(listenerDepartamento);
		getBtnGerarRelatrio().addActionListener(listenerDepartamento);
		getBtnRemover().addActionListener(listenerDepartamento);
		getBtnVoltar().addActionListener(listenerDepartamento);
	}
	private void initialize() {
		...
		contentPane_1.add(getLblListarDepartamento());
